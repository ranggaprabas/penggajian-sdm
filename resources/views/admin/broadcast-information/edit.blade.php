    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="{{ route('admin.divisi.index') }}">{{ $pages }}</a>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.divisi.update', $data->id) }}" method="POST"
                                ...
                                <div style="gap: .5rem;flex-wrap: wrap;"
                                    ...
                                    <input class="form-control gray-border" style="width: 80%;" type="text" id="divisi-input"
