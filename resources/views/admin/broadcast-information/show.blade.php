    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="{{ route('admin.broadcast-information.index') }}">{{ $pages }}</a>
                    </li>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>To</th>
                                        <td> @if ($relatedBroadcasts->isNotEmpty())
                                            {{ implode(', ', $relatedBroadcasts->pluck('sdm_name')->toArray()) }}
                                        @else
