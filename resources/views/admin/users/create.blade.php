...
@section('content')
                    ...
                    <ul class="navbar-nav header-right">
                        <li class="nav-item dropdown notification_dropdown">
                            <a class="btn btn-primary d-sm-inline-block position-relative" data-toggle="dropdown"
                                ...
                                {{ Auth::user()->nama }} <i class="fa fa-user ms-2 scale-5"></i>
                                @if (Auth::check())
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <form novalidate action="{{ route('admin.users.store') }}" method="POST"
                    onsubmit="return validateFormAdmin() && removeCommas2();">
                    @csrf
                    @if ($errors->any())
