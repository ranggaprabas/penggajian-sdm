    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="{{ route('admin.jabatan.index') }}">{{ $pages }}</a>
                    </li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.jabatan.update', $data->id) }}" method="POST"
                                onsubmit="return validateFormJabatan() && removeCommas();">
                                @csrf
                                @method('put')
                                <div class="mb-5 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control gray-border" style="width: 100%;" type="text"
                                            id="nama-jabatan" name="nama" value="{{ old('nama', $data->nama) }}">
                                    </div>
                                </div>
                                <div class="mb-5 row">
                                    <label class="col-sm-2 col-form-label" for="tunjangan_jabatan">Tunjangan Jabatan</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <span class="input-group-text">Rp.</span>
                                            <input class="form-control gray-border" style="width: 80%;" type="text"
                                                id="nilai-jabatan" name="tunjangan_jabatan" oninput="addCommas(this)"
